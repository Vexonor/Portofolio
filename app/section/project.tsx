    ...
    return (
        <div className="grid grid-cols-3 gap-4 gap-y-8 p-10">
            ...
            <div className="col-span-1">
                <figure className="ms-auto me-20 relative z-[1] max-w-full w-[50rem] h-auto shadow-[0_2.75rem_3.5rem_-2rem_rgb(45_55_75_/_20%),_0_0_5rem_-2rem_rgb(45_55_75_/_15%)] dark:shadow-[0_2.75rem_3.5rem_-2rem_rgb(0_0_0_/_20%),_0_0_5rem_-2rem_rgb(0_0_0_/_15%)] rounded-b-lg">
                    ...
                    <div className="bg-gray-800 rounded-b-lg">
                        <Image
                            className="max-w-full h-[43.75rem] rounded-b-lg object-cover object-top"
                ...
                <div className="grid grid-cols-1 mt-5">
                    <div className="col-span-1 text-white font-xl font-semibold font-poppins">Application Name : Focalors</div>
                    <div className="col-span-1 text-white font-xl font-semibold font-poppins">Used Programming Language :</div>
                    <div className="col-span-1 flex justify-center">
                        <div className="group relative">
                            ...
                            <span className="absolute -top-5 left-[50%] -translate-x-[50%] 
                                    z-20 origin-left scale-0 px-3 rounded-lg bg-crimson py-2 text-sm font-bold
                                    shadow-md transition-all duration-300 ease-in-out 
                                    group-hover:scale-100 font-poppins w-max text-white">PHP</span></div>
                    </div>
                    <div className="col-span-1 text-white font-xl font-semibold font-poppins">Used Framework :</div>
                    <div className="col-span-1 flex justify-center">
                        <div className="group relative">
                            ...
                            <span className="absolute -top-5 left-[40%] -translate-x-[50%] 
                                    z-20 origin-left scale-0 px-3 rounded-lg bg-crimson py-2 text-sm font-bold
                                    shadow-md transition-all duration-300 ease-in-out 
                                    group-hover:scale-100 font-poppins w-max text-white">Bootstrap</span></div>
                    </div>
                    <div className="col-span-1 text-white font-xl font-semibold font-poppins">Our Github :</div>
                    <div className="col-span-1 text-white flex justify-center">
                        <div className="group relative">
                            ...
                            <span className="absolute -top-5 left-[45%] -translate-x-[50%] 
                                    z-20 origin-left scale-0 px-3 rounded-lg bg-crimson py-2 text-sm font-bold
                                    shadow-md transition-all duration-300 ease-in-out 
                                    group-hover:scale-100 font-poppins w-max">Go Check</span></div>
                    </div>
                </div>
            </div>
            <div className="col-span-1">
                ...
                <div className="grid grid-cols-1 mt-5">
                    <div className="col-span-1 text-white font-xl font-semibold font-poppins">Application Name : Sistem Informasi SMK Muhammadiyah Plus Kota Batam</div>
                    <div className="col-span-1 text-white font-xl font-semibold font-poppins">Used Programming Language :</div>
                    <div className="col-span-1 flex justify-center">
                        <div className="group relative">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="45" height="45" viewBox="0 0 30 30">
                    ...
                    <div className="col-span-1 text-white font-xl font-semibold font-poppins">Used Framework :</div>
                    <div className="col-span-1 flex justify-center gap-10">
                        <div className="group relative">
                            ...
                            <span className="absolute -top-5 left-[40%] -translate-x-[50%] 
                                    z-20 origin-left scale-0 px-3 rounded-lg bg-crimson py-2 text-sm font-bold
                                    shadow-md transition-all duration-300 ease-in-out 
                                    group-hover:scale-100 font-poppins w-max text-white">Laravel</span></div>
                        <div className="group relative">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="45" height="45" viewBox="0 0 48 48">
                            ...
                            <span className="absolute -top-5 left-[40%] -translate-x-[50%] 
                                    z-20 origin-left scale-0 px-3 rounded-lg bg-crimson py-2 text-sm font-bold
                                    shadow-md transition-all duration-300 ease-in-out 
                                    group-hover:scale-100 font-poppins w-max text-white">Tailwind</span></div>
                    </div>
                    <div className="col-span-1 text-white font-xl font-semibold font-poppins">Our Github :</div>
                    <div className="col-span-1 text-white flex justify-center">
                        <div className="group relative">
            ...
            <div className="col-span-3 my-5">
                <h1 className="skew-y-3 my-5 relative isolation-auto z-10 before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full hover:text-white before:-left-full before:hover:left-0 before:rounded-full before:bg-crimson before:-z-10 before:aspect-square before:hover:scale-150 overflow-hidden before:hover:duration-700 inline-flex items-center justify-center px-4 py-3 font-bold text-crimson bg-white shadow-sm gap-x-2 hover:bg-gray-50 disabled:opacity-50 text-xl">Project Based Learning Mobile Development</h1>
            </div>
            <div className="col-span-1 flex flex-col justify-center items-center">
                ...
                <div className="grid grid-cols-1 mt-5">
                    <div className="col-span-1 text-white font-xl font-semibold font-poppins">Application Name : Trashify</div>
                    <div className="col-span-1 text-white font-xl font-semibold font-poppins">Used Programming Language :</div>
                    <div className="col-span-1 flex justify-center">
                        <div className="group relative">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="45" height="45" viewBox="0 0 48 48">
                            ...
                            <span className="absolute -top-5 left-[50%] -translate-x-[50%] 
                                    z-20 origin-left scale-0 px-3 rounded-lg bg-crimson py-2 text-sm font-bold
                                    shadow-md transition-all duration-300 ease-in-out 
                                    group-hover:scale-100 font-poppins w-max text-white">Dart</span></div>
                    </div>
                    <div className="col-span-1 text-white font-xl font-semibold font-poppins">Used Framework :</div>
                    <div className="col-span-1 flex justify-center">
                        <div className="group relative">
                            ...
                            <span className="absolute -top-5 left-[40%] -translate-x-[50%] 
                                    z-20 origin-left scale-0 px-3 rounded-lg bg-crimson py-2 text-sm font-bold
                                    shadow-md transition-all duration-300 ease-in-out 
                                    group-hover:scale-100 font-poppins w-max text-white">Flutter</span></div>
                    </div>
                    <div className="col-span-1 text-white font-xl font-semibold font-poppins">Our Github :</div>
                    <div className="col-span-1 text-white flex justify-center">
                        <div className="group relative">
            ...
            <div className="col-span-3 mb-5">
                <h1 className="skew-y-3 mb-5 relative isolation-auto z-10 before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full hover:text-white before:-left-full before:hover:left-0 before:rounded-full before:bg-crimson before:-z-10 before:aspect-square before:hover:scale-150 overflow-hidden before:hover:duration-700 inline-flex items-center justify-center px-4 py-3 font-bold text-crimson bg-white shadow-sm gap-x-2 hover:bg-gray-50 disabled:opacity-50 text-xl">Wireframe</h1>
            </div>
            {/* Wireframe 1 */}
            <div className="col-span-1">
                <figure className="ms-auto me-20 relative z-[1] max-w-full w-[50rem] h-auto shadow-[0_2.75rem_3.5rem_-2rem_rgb(45_55_75_/_20%),_0_0_5rem_-2rem_rgb(45_55_75_/_15%)] dark:shadow-[0_2.75rem_3.5rem_-2rem_rgb(0_0_0_/_20%),_0_0_5rem_-2rem_rgb(0_0_0_/_15%)] rounded-b-lg">
                    <div className="relative flex items-center max-w-[50rem] bg-white rounded-t-lg py-2 px-24 dark:bg-neutral-700">
                        ...
                        <div className="flex justify-center items-center size-full bg-gray-700 text-[.25rem] text-gray-400 rounded-sm sm:text-[.5rem] dark:bg-neutral-600 dark:text-neutral-400 font-poppins">www.website.com</div>
                    </div>
